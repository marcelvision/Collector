...
namespace Cointero
{
    public partial class Main : Form
    {
        ...
        bool image_models_array_set = false;
        ...
        public void imagesDisplay()
        {
            ...
            try
            {
                ...
                {
                    /* Conversion one -working
                    Image<Bgr, Byte> imageTopC = new Image<Bgr, byte>(imageTop.Width, imageTop.Height);
                    Mat imageTopX = iP4.mColorConvRgbBgr();
                    imageTopC = imageTopX.ToImage<Bgr, Byte>();
                    */
                    WriteDebug("before image saving");
                    /* conversion rgb bgr did not work righ 
                    ImageProc iP1 = new ImageProc();                    
                    Bitmap imageTopInv1 = iP1.mColorConvRgbBgr(CamGrab.m_Bitmap2ShowT);
                    */
        ...
        */
        ...
        private void DecodeFromFile()
        {
            ...
            ImageProc._image_models_array_set = image_models_array_set;
        ...
        private void DecodeFromCamera()
        {
            ...
            */
            ...
            catch (Exception eFitline2)
            {
                WriteDebug("mFitLine:" + eFitline2.Message);
            }
            */

            WriteDebug("start Find circle on model (mod)");
